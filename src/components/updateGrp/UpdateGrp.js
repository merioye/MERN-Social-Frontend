...
const UpdateGrp = ({ setShowUpdateGrp, setShowConversation }) => {
    ...
    const [showUpdateGrpSubjectInput, setShowUpdateGrpSubjectInput] =
        useState(false);
    ...
    const [addParticipantSearchedUsers, setAddParticipantSearchedUsers] =
        useState([]);
    const [showAddParticipantSearchLoader, setShowAddParticipantSearchLoader] =
        useState(false);
    const [newParticipantsToAdd, setNewParticipantsToAdd] = useState([]);
    const [showAddNewParticipantLoader, setShowAddNewParticipantLoader] =
        useState(false);
    ...
    const onSelectingFile = async (e) => {
        ...
        try {
            ...
            const res = await fetch(
                `${process.env.REACT_APP_API_BASE_URL}/chats/${selectedConversationInfo._id}?type=grpIcon`,
                {
                    method: "PUT",
                    credentials: "include",
                    body: formData,
    ...
    const updateGrpSubject = async () => {
        ...
        try {
            ...
            const res = await fetch(
                `${process.env.REACT_APP_API_BASE_URL}/chats/${selectedConversationInfo._id}?type=grpSubject`,
                {
                    method: "PUT",
                    credentials: "include",
                    body: formData,
            ...
            let updatedChats = chats.filter((cht) => {
                if (cht._id === data.updatedChat._id) {
                    const { grpSubject, lastMessage, lastMessageDate } =
                        data.updatedChat;
                    modifiedChat = {
                        ...cht,
            ...
            setSelectedConversationInfo({
                ...selectedConversationInfo,
                grpSubject: data.updatedChat.grpSubject,
            });
            setMessages([...messages, newMessage]);
    ...
    const updateGrpDesc = async () => {
        ...
        try {
            ...
            const res = await fetch(
                `${process.env.REACT_APP_API_BASE_URL}/chats/${selectedConversationInfo._id}?type=grpDesc`,
                {
                    method: "PUT",
                    credentials: "include",
                    body: formData,
            ...
            let updatedChats = chats.filter((cht) => {
                if (cht._id === data.updatedChat._id) {
                    const { grpDesc, lastMessage, lastMessageDate } =
                        data.updatedChat;
                    modifiedChat = {
                        ...cht,
                        grpDesc: grpDesc,
            ...
            setSelectedConversationInfo({
                ...selectedConversationInfo,
                grpDesc: data.updatedChat.grpDesc,
            });
            setMessages([...messages, newMessage]);
    ...
    const handleAddParticipantSearch = (e) => {
        ...
        searchUser(
            val,
            setShowAddParticipantSearchLoader,
            setAddParticipantSearchedUsers
        );
    };
    ...
    const removeParticipantFromNewParticipantToAdd = (userId) => {
        let updatedNewParticipantsToAdd = newParticipantsToAdd.filter(
            (user) => {
    ...
    const addNewSelectedParticipantsToGrp = async () => {
        ...
        try {
            const newParticipantsToAddIds = newParticipantsToAdd.map(
                (participant) => {
            ...
            const res = await fetch(
                `${process.env.REACT_APP_API_BASE_URL}/chats/${selectedConversationInfo._id}?type=addNewParticipants`,
                {
                    method: "PUT",
                    credentials: "include",
                    body: formData,
    ...
    const handleExitGroupConfirmClick = async () => {
        ...
        try {
            ...
            const res = await fetch(
                `${process.env.REACT_APP_API_BASE_URL}/chats/${selectedConversationInfo._id}?type=exitGrpParticipant`,
                {
                    method: "PUT",
                    credentials: "include",
                    body: formData,
    ...
    const handleDeleteGroupConfirmClick = async () => {
        ...
        try {
            const res = await fetch(
                `${process.env.REACT_APP_API_BASE_URL}/chats/${selectedConversationInfo._id}`,
                {
                    method: "DELETE",
                    credentials: "include",
                }
    ...
    return (
        <>
            <motion.div
                className="update-grp-container"
                initial={{ x: "100%" }}
                animate={{ x: 0 }}
            ...
            >
                <div className="update-grp-header">
                    <motion.span
                        className="update-grp-cancel"
                        onClick={() => setShowUpdateGrp(false)}
                        title="Close"
                ...
                <div className="update-grp-info-container">
                    <form encType="multipart/form-data">
                        <div className="update-grp-image-container">
                            {
                                <>
                                    {showGrpIconLoader && (
                                        <div className="update-grp-image-loader-container">
                                            <img
                                                src="images/spiner2.gif"
                                                alt="loader"
                                                className="grpIconLoader"
                                            />
                                        </div>
                                    )}
                                    <img
                                        ...
                                        alt="grpIcon"
                                    />
                                    {grpAdmins.includes(user._id) ||
                                    grpEditInfo === "all"
                                        ? !showGrpIconLoader && (
                                              <div
                                                  className="update-grp-image"
                                                  title="Update icon"
                                              >
                        ...
                        {showUpdateGrpSubjectInput ? (
                            <div className="update-grp-input-wrapper">
                                ...
                                <input
                                    type="text"
                                    value={updateGrpSubjectVal}
                                    onChange={(e) =>
                                        setUpdateGrpSubjectVal(e.target.value)
                                    }
                                    ref={updateGrpSubjectRef}
                                />
                            ...
                            <h2 className="update-grp-name">
                                ...
                                {(grpAdmins.includes(user._id) ||
                                    ...
                                    <i
                                        ...
                                        title="Click to edit"
                                        onClick={showGrpSubjectUpdateBox}
                                    ></i>
                                )}
                            </h2>
                        )}
                        <p className="grp-participants">
                            Group - {users.length} participants
                        </p>
                    </form>

                    <div
                        className="grp-desc-and-date"
                        style={
                            showUpdateGrpDescInput ? { padding: "20px" } : null
                        }
                    >
                        {showUpdateGrpDescInput ? (
                            <div
                                className="update-grp-input-wrapper"
                                style={{ marginTop: "0px" }}
                            >
                                <i
                                    className="far fa-grin"
                                ...
                                <input
                                    type="text"
                                    style={{ fontSize: "16px" }}
                                    value={updateGrpDescVal}
                                    onChange={(e) =>
                                        setUpdateGrpDescVal(e.target.value)
                                    }
                                    ref={updateGrpDescRef}
                                />
                                {showGrpDescLoader ? (
                                    <img
                                        src="/images/spiner2.gif"
                        ...
                        >
                            {grpCreator === user._id ||
                            grpCreator._id === user._id
                                ? `Group created by you, on ${new Date(
                                      createdAt
                    ...
                    {(grpAdmins.includes(user._id) ||
                        grpEditInfo === "all") && (
                        <motion.div
                            className="grp-settings-wrapper"
                            onClick={() =>
                                setTimeout(() => setShowGrpSettings(true), 200)
                            }
                            initial={{ background: "#fff" }}
                            whileTap={{ background: "rgba(53, 53, 53, 0.05)" }}
                        >
                    ...
                    <div className="grp-participants-wrapper">
                        ...
                        {(grpAdmins.includes(user._id) ||
                            grpEditInfo === "all") && (
                            <motion.div
                                className="update-grp-add-participant"
                                onClick={() =>
                                    setTimeout(
                        ...
                        <div
                            className="update-grp-add-participant-modal-container"
                            style={
                        ...
                        >
                            <motion.div
                                className="update-grp-add-participant-modal"
                            ...
                            >
                                <div className="update-grp-add-participant-modal-header">
                                    <motion.span
                                        className="update-grp-add-participant-modal-cancel"
                                        onClick={() =>
                                            setShowAddParticipantModal(false)
                                        }
                                        title="Close"
                                ...
                                <div className="add-participant-modal-bottom">
                                    <input
                                        type="text"
                                        placeholder="Search..."
                                        value={addParticipantSearchVal}
                                        onChange={handleAddParticipantSearch}
                                    />

                                    <div
                                        className="add-participant-modal-search-results"
                                        style={
                                    ...
                                    >
                                        {showAddParticipantSearchLoader ? (
                                            <img
                                                src="/images/spiner2.gif"
                                                alt="loader"
                                                className="add-participant-modal-search-results-loader"
                                            />
                                        ) : addParticipantSearchedUsers.length ? (
                                            addParticipantSearchedUsers.map(
                                                (searchedParticipant) => {
                                                    return (
                                                        <div
                                                            className="add-participant-modal-search-result"
                                                            key={
                                                                searchedParticipant._id
                                                            }
                                                            onClick={() =>
                                                                addNewParticipantToGrp(
                                                                    searchedParticipant
                                                        ...
                                                        >
                                                            <img
                                                                src={
                                                                    searchedParticipant.profileImage
                                                                }
                                                                alt="profileImage"
                                                            />
                                                            <h3>
                                                                {formatName(
                                                                    searchedParticipant.name
                                                                )}
                                                            </h3>
                                                        </div>
                                                    );
                                    ...
                                    {Boolean(newParticipantsToAdd.length) && (
                                        <div className="add-participant-modal-users-list">
                                            {newParticipantsToAdd.length
                                                ? newParticipantsToAdd.map(
                                                      (participantToAdd) => {
                                                          return (
                                                              <div
                                                                  className="add-participant-modal-user"
                                                                  key={
                                                                      participantToAdd._id
                                                                  }
                                                              >
                                                                  <img
                                                                      src={
                                                                          participantToAdd.profileImage
                                                                      }
                                                                      alt="userAvatar"
                                                                  />
                                                                  <p>
                                                                  ...
                                                                  <span
                                                                      onClick={() =>
                                                                          removeParticipantFromNewParticipantToAdd(
                                                                              participantToAdd._id
                                                                          )
                                                                      }
                                                                  >
                                    ...
                                    {Boolean(newParticipantsToAdd.length) && (
                                        <motion.button
                                            className="add-participant-modal-addUsers-btn"
                                            onClick={
                                                addNewSelectedParticipantsToGrp
                                            }
                                            disabled={
                                        ...
                                        >
                                            {showAddNewParticipantLoader ? (
                                                ...
                                                >
                                                    <path
                                                        fill="currentColor"
                                                        d="m8 17.1-5.2-5.2-1.7 1.7 6.9 7L22.9 5.7 21.2 4 8 17.1z"
                                                    ></path>
                                                </svg>
                                            )}
                                        </motion.button>
                    ...
                    <motion.div
                        className="update-grp-exit-and-delete"
                        onClick={() =>
                            setTimeout(() => setShowExitGroupModal(true), 200)
                        }
                        initial={{ background: "#fff" }}
                        whileHover={{ background: "#f5f6f6" }}
                        whileTap={{ background: "rgba(53, 53, 53, 0.05)" }}
                    >
                        <svg viewBox="0 0 24 24" width="24" height="24">
                            <path
                                fill="currentColor"
                                d="m16.6 8.1 1.2-1.2 5.1 5.1-5.1 5.1-1.2-1.2 3-3H8.7v-1.8h10.9l-3-3zM3.8 19.9h9.1c1 0 1.8-.8 1.8-1.8v-1.4h-1.8v1.4H3.8V5.8h9.1v1.4h1.8V5.8c0-1-.8-1.8-1.8-1.8H3.8C2.8 4 2 4.8 2 5.8v12.4c0 .9.8 1.7 1.8 1.7z"
                            ></path>
                        </svg>
                        <p>Exit group</p>
                    </motion.div>
                ...
                {showGrpSettings && (
                    <GrpSettings
                        setShowGrpSettings={setShowGrpSettings}
                ...
                showExitGroupModal &&{" "}
                <div
                    className="exit-group-modal-container"
                    style={showExitGroupModal ? null : { display: "none" }}
                >
                    <div className="exit-group-modal" ref={exitGroupModal}>
                        ...
                        <div className="exit-group-modal-btns">
                            ...
                            <button
                                ...
                                onClick={handleExitGroupConfirmClick}
                                disabled={showExitGroupLoader}
                            >
                                {showExitGroupLoader ? (
                                    <img
                                        src="/images/spiner2.gif"
                ...
                <div
                    className="delete-group-modal-container"
                    style={showDeleteGroupModal ? null : { display: "none" }}
                >
                    <div className="delete-group-modal" ref={deleteGroupModal}>
                        ...
                        <div className="delete-group-modal-btns">
                            ...
                            <button
                                ...
                                disabled={showDeleteGroupLoader}
                            >
