    ...
    const handleResetPasswordSubmit = async (e) => {
        ...
        try {
            ...
            if (res.status === 403) {
                ...
                errorMessage =
                    "It seems that the reset password link has been expired, please request a new one!";
                throw new Error(res.statusText);
            } else if (!res.ok) {
            ...
            <div className="reset-password-form">
                <form onSubmit={handleResetPasswordSubmit}>
                    <div className="resetpassword-input-container">
                        <label className="resetpassword-input-label">
                            Password <sup style={{ color: "red" }}>*</sup>
                            <i
                                className="fas fa-eye resetpassword-input-icon"
                                onClick={togglePasswordVisibility}
                                id="pass-show"
                            ></i>
                            <i
                                className="fas fa-eye-slash resetpassword-input-icon"
                                id="pass-hide"
                                ref={passHide}
                                onClick={togglePasswordVisibility}
                            ></i>
                        ...
                        <input
                            type="password"
                            className="resetpassword-inputBox"
                            ref={passRef}
