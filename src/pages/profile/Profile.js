    ...
    const handleCoverAndProfilePhoto = async (e) => {
        if (e.target.files[0]) {
            ...
            try {
                ...
                if (e.target.name === "coverImage") {
                    res = await fetch(
                        `${process.env.REACT_APP_API_BASE_URL}/profile/${profileUserId}/coverImage`,
                        {
                            method: "PUT",
                            credentials: "include",
                            body: formData,
                    ...
                    res = await fetch(
                        `${process.env.REACT_APP_API_BASE_URL}/profile/${profileUserId}/profileImage`,
                        {
                            method: "PUT",
                            credentials: "include",
                            body: formData,
                    ...
                    <div className="cover-photo-wrapper">
                        <div className="cover-photo">
                            ...
                            {user.username === profileUser.username && (
                                <>
                                    <div className="cover-photo-update-btn">
                            ...
                            {showCoverPhotoLoader && (
                                <div className="cover-photo-loader">
                                    <img
                        ...
                        <div className="profile-short-info">
                            <div className="profile-photo">
                                ...
                                {user.username === profileUser.username && (
                                    <>
                                        <div
                                            className="profile-photo-update-btn"
                                            style={
                            ...
                            <h1>{formatName(profileUser.name)}</h1>
                            {user.username === profileUser.username ? (
                                <Link
                                    to={`/profile/${profileUserId}/edit`}
                            ...
                            <div className="profile-posts">
                                {profilePosts.length ? (
                                    <InfiniteScroll
                                        ...
                                        endMessage={
                                            <NoPostOrFollow title="No more posts!" />
                                        }
                                    >
                                        {[
                                            ...new Map(
                    ...
                    {activeTab === "about" && (
                        <div>
                            <div className="profile-about">
                                <h2>{formatName(profileUser.name)}</h2>
                                {profileUser.bio && (
